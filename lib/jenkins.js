...
function Jenkins(runner) {
  ...
  function genSuiteReport() {
    ...
    writeString(' skipped="'+(Math.abs(currentSuite.tests.length-currentSuite.failures-currentSuite.passes))+'"');
	...
	//if the number of tests in the suite 
	if (currentSuite.tests.length != currentSuite.passes+currentSuite.failures) {
